...
const cityData = {
 ...
 'Texas': {
   memory: [
   {desc: "We rode electric scooters all around Texas!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Ate lots of barbeque! You were spamming the sauce at Terry Black's!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "You sneezed like a cow because of your pollen allergy!", pic: "https://www.shutterstock.com/search/singapore"},
   ],
 },
 'Hawaii': {
   memory: [
   {desc: "We went snorkeling at Ahihi Bay! Saw many big fishes", pic: "https://www.shutterstock.com/search/singapore"},
   ...
   {desc: "Ate lotsa seafood!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "We ate a lot of Hawaiian BBQ LOL and afterwards you got sick of it. And also sick of the island and got island fever!"},
   {desc: "We went to the hospital cos you stepped on a nail LOL", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "On the last night, we wanted to have a hot bath but the bathroom ran out of hot water LOL"},
   {desc: "On the last night, we painted half of our painting LOL", pic: "https://www.shutterstock.com/search/singapore"},
   ],
},
'Canada': {
   memory: [
   {desc: "You couldn't speak French LOL and didn't wanna head out when I got stuck at the airport in Newark", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "You were obsessed with Canadian macs Serieusement Poulet and I ordered it in French for you", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Many pretty buildings and old cobblestone paths!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Almost ate rabbits at Vieux-Quebec!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Spent 8 dollars on a funiculaire aka expensive elevator", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "HOLDER'S!! DRANK GREAT WINE AND HAD GREAT FOOD AND another great activity after ;)", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Chilled at Tim Hortons all day every day", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "We bought lotsa maple products at the store and you had a business idea on maple boba!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Saw super big crab that sells for super cheap!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Saw Niagara Falls!! Saw that the Canadian side was so touristy", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Great Japanese food and The Alley boba with blueberry aftertaste!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Airbnb has a candy machine and Alexa!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "It was cold at Niagara and you were a sniffly boy!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Had Tim Hortons for the first time!", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Had the gallons-litres and conversion rate scare LOL", pic: "https://www.shutterstock.com/search/singapore"},
   {desc: "Had Nando's Perry Perry Chicken picnic!", pic: "https://www.shutterstock.com/search/singapore"},
   ],
},
'Quebec City': {
   memory: [
